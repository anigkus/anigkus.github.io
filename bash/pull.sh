...
##
#
#Reference: https://zhangguanzhang.github.io/bash/pull.sh
#

#
#Usage: curl -s https://anigkus.github.io/bash/pull.sh | bash -s -- gcr.io/google-containers/kube-addon-manager:v6.3
#
